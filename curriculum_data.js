const MODULE_DATA = [
    {
        id: 0,
        title: "Introductory Essentials",
        audioLink: "https://battlefield.buzzsmart.org/audio/intro.mp3",
        content: `
            <h3>Module Overview: Joy and RRR</h3>
            <p>The joy of the Lord is our strength. As Newspaper writers say: "Tell them, then tell them what you told them, then tell them once more memorably." [cite: 3, 4]</p>
            <h3>Observation and Practice</h3>
            <p>All doctorate-level knowledge follows a cycle: observe, diagnose, treat, verify. In theology, we observe the Word, hypothesize, and recertify endlessly. [cite: 14, 16]</p>
            <p><em>Key Scripture: John 9:1-3 — God's works displayed in us. [cite: 10, 11]</em></p>
        `
    },
    {
        id: 1,
        title: "Chapter 1: For Christ",
    ...
    {
        id: 2,
        title: "Chapter 2: Christ Leads, Always",
        audioLink: "https://battlefield.buzzsmart.org/audio/ch2.mp3",
        content: `
